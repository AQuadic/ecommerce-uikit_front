...
function Signup() {
  ...
  const sin = () => {
    ...
    const po = axios
      .post(
        "https://v2.freshfarm.ae/api/v1/users/auth/signup",
        {
          name: name,
          email: email,
  ...
  return (
    <Container>
      <section className=" login signup ">
        ...
        <Card>
          <Card.Body>
            <h2 className="text-center mb-4">{t("Sign.head2")}</h2>
            <p className="text-center ">{t("Sign.head3")}</p>
            <Form>
              <Form.Group>
                <Form.Control
                  id="First-Name"
        ...
        <div className="w-100 not text-center ">
          <Link to="/login"> {t("Sign.pay_f3")} </Link>
        </div>
      </section>
    </Container>
  );
